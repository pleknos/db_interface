    ...
    return (
      <div className="filterModal">
        <div className="fmContents">
          ...
          />
          {firstOption !== '' &&
            this.columns[firstOption].type === 'table' && (
              <Select
                value={secondOption}
                onChange={this.handleSecondChange}
                placeholder="Значение"
                options={(firstOption !== '' && this.columns[firstOption].contents) || []}
                noResultsText="Совпадения не найдены"
                multi={false}
                labelKey="name"
                valueKey="id"
              ...
              <div className="Select">
                <div className="Select-control field">
                  <div className="Select-input">
                    <input type="text" placeholder="Значение" value={secondOption} onChange={this.handleInputChange} />
                  </div>
                </div>
              </div>
            )}
          ...
          <br />
          <button onClick={this.props.onClick} className="fmCls">
            Закрыть
          </button>
        </div>
      </div>
